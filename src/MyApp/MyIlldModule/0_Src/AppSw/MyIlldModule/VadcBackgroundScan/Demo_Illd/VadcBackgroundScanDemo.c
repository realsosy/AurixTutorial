...
//		adcChannelConfig[chnIx].channelId         = (IfxVadc_ChannelId)(2 + chnIx);
//		adcChannelConfig[chnIx].resultRegister    = (IfxVadc_ChannelResult)(2 + chnIx); // use register #0 and 1 for results
//		adcChannelConfig[chnIx].channelId         = (IfxVadc_ChannelId)(4 + chnIx);
//		adcChannelConfig[chnIx].resultRegister    = (IfxVadc_ChannelResult)(4 + chnIx); // use register #0 and 1 for results
